...
describe DriversController do
  ...
  describe "show action" do
    ...
    it "should show a valid driver" do
  ...
  describe "update" do
    ...
    it "can update an existing driver with valid information accurately, and redirect" do
      ...
      patch edit_driver_path(driver), params: updated_driver_form_data
      
      # expect {
      #   patch edit_driver_path(existing_driver), params: updated_driver_form_data
